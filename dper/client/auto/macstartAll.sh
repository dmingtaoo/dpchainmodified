...
osascript -e 'tell application "Terminal" to do script "cd /Users/dengmingtao/Documents/GitHub/dpchain/dper/client/auto/dper_dper4 && ./start.sh; exec bash"'
sleep 20
...
osascript -e 'tell application "Terminal" to do script "cd /Users/dengmingtao/Documents/GitHub/dpchain/dper/client/auto/dper_dper4 && ./run_contract.sh; exec bash"'
